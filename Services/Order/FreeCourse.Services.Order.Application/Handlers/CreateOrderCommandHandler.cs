...
using FreeCourse.Services.Order.Infrastructrure;
...
{
    public class CreateOrderCommandHandler : IRequestHandler<Commands.CreateOrderCommand, Response<CreatedOrderDto>>
    {
